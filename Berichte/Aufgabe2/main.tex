...
%Der \texttt{TrafficLight}-Prozess wird so erweitert, dass er aktiv Signale zur Übergabe (\texttt{handover_control}) und Übernahme (\texttt{take_control}) der Wegerechte nutzt. In Listing \ref{lst:trafficlight-sync} ist die neue Logik für den Zustand \texttt{red} ersichtlich: Eine rote Ampel wartet auf das Bereitschaftssignal der Gruppe (\texttt{wait_for}) und führt dann einen synchronisierten Wechsel mit der Gegenrichtung aus.
//TODO
